...
export default function PortfolioClient() {
  ...
  return (
    <>
      <Head>
        <title>Imdad Malik | Global Technical SEO & AI Search Optimization Specialist</title>
        <meta
          name="description"
          content="Imdad Malik – Global Technical SEO & AI Search Expert specializing in AEO & GEO, helping SaaS, ecommerce & enterprise businesses scale organic traffic worldwide."
        />
        <meta
          name="keywords"
          content="Imdad Malik SEO Expert, Global SEO Specialist, Technical SEO, AI SEO, Semantic SEO, On-Page SEO, Off-Page SEO, International SEO, Schema, Structured Data, Global Technical SEO, AI Search Optimization, AEO, GEO, SaaS SEO expert, ecommerce SEO strategist, enterprise SEO consultant, on-page SEO, off-page SEO, technical SEO audits, organic traffic growth"
        />
        <link rel="canonical" href="https://technovavista.vercel.app/" />
        <script
          ...
          dangerouslySetInnerHTML={{ __html: `
          {
            ...
            "image": "https://technovavista.vercel.app/imdad-malik-seo-expert.jpg",
            "sameAs": ["https://www.linkedin.com/in/imdad-malik/"],
            "jobTitle": "Global SEO Expert & AI Search Optimization Specialist",
            "worksFor": {
              "@type": "Organization",
              "name": "TechNovaVista"
            }
        ...
        <section className="grid md:grid-cols-2 gap-6 items-start">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-gray-900 dark:text-white">
              Imdad Malik | Global Technical SEO & 
              <br/>
    ...
    />
        ...
        <section className="mt-24 text-center">
          <h2 className="text-3xl font-bold">
            Grow Your Organic Traffic Globally
          </h2>
